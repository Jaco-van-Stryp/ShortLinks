...
namespace ShortLinks_Final.Controllers
{
    ...
    public class LinksController : Controller
    {
        ...
        {
            if (url.LongURL == null || url.ShortURL == null || url.LongURL == "" || url.ShortURL == "" || url.LongURL.StartsWith("https://shortlinks.hubby.business/s/")) return BadRequest("URL Not Allowed");
